 ...
 */
  ...
  $GLOBALS['root'] = 'http://10.1.10.96/south-street-partners/';
  $GLOBALS['docpath'] = $_SERVER['DOCUMENT_ROOT'].'/south-street-partners';
 ...
 add_filter( 'wp_mail_from_name', function($name) {
    return 'Southeast Street Partners';
  });
